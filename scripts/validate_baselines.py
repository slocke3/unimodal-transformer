"""
Validate the empirical k-gram baseline against the doubling map (x -> 2x mod 1),
...
baseline CE changes with order -- and the *shape* of
...
from src.baselines import KGramModel, make_context_target_pairs, kgram_baseline_curve
...
def main():
    ...
    print("\nIllustration -- k-gram CE vs order shows where memory matters:")
    ...
    print("  memory is essential and the empirical baseline reflects it.")
    ce35 = kgram_baseline_curve(
